        ...
        <div class="<?php echo esc_attr( implode( ' ', $container ) ); ?>">
			...
			<?php if ( 'post' === $post->post_type ) : ?>
                ...
                <p class="et_post_bg_color_setting et_divi_format_setting et_pb_page_settings">
                    <input id="et_post_bg_color" name="et_post_bg_color" class="color-picker-hex" type="text" maxlength="7" placeholder="<?php esc_attr_e( 'Hex Value', 'Divi' ); ?>" value="<?php echo esc_attr( $post_bg_color ); ?>"
...
function et_divi_add_customizer_css() {
	...
	if ( isset( $et_one_font_languages[ $site_domain ] ) ) {
		...
		<?php
	} else if ( ! in_array( $et_gf_heading_font, array( '', 'none' ) ) || ! in_array( $et_gf_body_font, array( '', 'none' ) ) || ! in_array( $et_gf_buttons_font, array( '', 'none' ) ) || ! in_array( $et_gf_primary_nav_font, array(
			'',
			'none'
		) ) || ! in_array( $et_gf_secondary_nav_font, array( '', 'none' ) ) || ! in_array( $et_gf_slide_nav_font, array( '', 'none' ) ) ) {
