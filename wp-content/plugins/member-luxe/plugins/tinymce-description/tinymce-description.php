...
function wpm_rich_text_tags() {
	...
	if(	$pagenow == 'edit-tags.php' || (version_compare(get_bloginfo('version'), '4.5', '>=') && $pagenow == 'term.php')) {  //
		...
		$isEditCategory = (isset($_GET['action']) && $_GET['action'] == 'edit' && $_GET['taxonomy'] == 'wpm-category')
			|| (version_compare(get_bloginfo('version'), '4.5', '>=') && $_GET['taxonomy'] == 'wpm-category' && $pagenow == 'term.php');
		if( $isEditCategory){
