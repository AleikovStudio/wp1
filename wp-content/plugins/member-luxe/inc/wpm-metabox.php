...
function wpm_page_extra()
{
    ...
    <ul class="ui-tabs-nav tabs-nav">
        <li><a href="#wpm_tab_1">Краткое описание</a></li>
        <li><a href="#wpm_tab_3">Подписки</a></li>
        <li><a href="#wpm_tab_4">Интеркасса</a></li>
        <li><a href="#wpm_tab_7">Скрипты</a></li>
        <li><a href="#wpm_tab_10">Автотренинг</a></li>
        <?php if (wpm_is_interface_2_0()) : ?>
            <li><a href="#wpm_tab_11">Вложения</a></li>
            <li><a href="#wpm_tab_12">Фоновое изображение</a></li>
            <li><a href="#wpm_tab_13">Индикаторы</a></li>
        <?php endif; ?>
    </ul>
    <div class="tab" id="wpm_tab_1">
        ...
        <div class="wpm-tab-content">
            ...
            <?php else : ?>
                <textarea class="large-text" name="mbl_short_description" rows="10" id="mbl_short_description"><?php echo get_post_meta(get_the_ID(), 'mbl_short_description', true); ?></textarea>
                <br style="clear: both;">
<?php /*
                    <script type="text/javascript">
                        (function($) {
                            var $description = $('#mbl_short_description'),
                                $marker = $('#mbl_short_description_marker'),
                                length = 150;

                            $description
                                .on('keydown', function (e) {
                                    var $this = $(this);
                                    var textLength = $this.val().length - ($this[0].selectionEnd - $this[0].selectionStart);
                                ...
                                .on('keyup', function (e) {
                                    $marker.text(Math.max(0, length - $(this).val().length));
                                })
                                .on('paste', function (e) {
                                    var bufferText = ((e.originalEvent || e).clipboardData || window.clipboardData).getData('Text');
                                    e.preventDefault();
                                    var all = $(this).val() + bufferText;
                                    document.execCommand('insertText', false, all.substring(0, length));
                                    Math.max(0, $marker.text(length - $(this).val().length));
                                })
                        })(jQuery);
                    </script>
*/ ?>
