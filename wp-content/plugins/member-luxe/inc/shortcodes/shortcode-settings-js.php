    ...
    function wpm_shortcode_settings_admin_js()
    {
        ...
        jQuery(function ($) {
            ...
            $('#wpm-arrow-submit').live('click', function () {
                ...
                var shortcode = '<p class="aligncenter"><img class="aligncenter ps_arrow" src="//static.wppage.ru/wppage/i/arrows/' + arrow_name + extention + '" alt="" /></p>';
            ...
            $('#wpm-header-submit').live('click', function () {
                ...
                var shortcode = '<p class="aligncenter"><img class="aligncenter wpm_header" src="//static.wppage.ru/wppage/i/headers/' + header + '.png" alt="" /></p><p>&nbsp;</p>';
            ...
            $('#wpm-satisfaction-submit').live('click', function () {
                ...
                var shortcode = '<p><img class="aligncenter ps_satisfaction" src="//static.wppage.ru/wppage/i/satisfaction/' + satisfaction + '.png" alt="" /></p>';
            ...
            wpm_comment_filters();
            $('#wpm-category').on('change', function () {
                wpm_comment_filters();
            });
