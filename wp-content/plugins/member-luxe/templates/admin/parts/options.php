                    ...
                    <div class="wpm-tab-content">
                        <div class="wpm-inner-tabs" tab-id="h-tabs-3">
                            ...
                            <div class="wpm-inner-tab-content" id="wpm_inner_tab_6_3">
                                <div>
                                    <h3><?php _e('Уведомление администратора об ответе на домашнее заданее', 'wpm'); ?></h3>
                                    <div class="wpm-row">
                                        <label>
                                            Заголовок письма<br>
                                ...
                                <br><br>
                                <div>
                                    <h3><?php _e('Уведомление пользователя о комментарии к ответу на домашнее заданее', 'wpm'); ?></h3>
                                    <div class="wpm-row">
                                        <label>
                                            Заголовок письма<br>
